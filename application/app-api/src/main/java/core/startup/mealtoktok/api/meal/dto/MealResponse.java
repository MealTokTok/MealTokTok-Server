...
public record MealResponse(Long mealId, String mealName, Money mealPrice, boolean isDeleted) {

    public static MealResponse from(Meal meal) {
        return new MealResponse(
                meal.getMealId(),
                meal.getMealInfo().mealName(),
                meal.getMealInfo().mealPrice(),
                meal.getMealInfo().isDeleted());
    }
}
