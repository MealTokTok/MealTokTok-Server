...
public class UserApi implements UserApiDocs {
  ...
  public Response<TargetUser> addAddress(@PathVariable Long userId,
      AddressInfoRequest addressInfoRequest) {

    return Response.success(
        userService.addAddress(TargetUser.from(userId),
            addressInfoRequest.toAddressWithCoordinate()));
  }
