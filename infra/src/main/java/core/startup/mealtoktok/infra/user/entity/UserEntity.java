...
public class UserEntity extends BaseTimeEntity {
  ...
  public static UserEntity from(User user) {
    return UserEntity.builder()
        ...
        .deliveryAddresses(
            user.getDeliveryAddresses().stream().map(DeliveryAddressEntity::from)
                .toList())
  ...
  public static UserEntity from(OAuthInfo oAuthInfo, String deviceToken, UserProfile userProfile,
  ...
  public User toDomain() {
    return User.builder()
        ...
        .userProfile(
            UserProfile.of(username, nickname, gender, phoneNumber, birth, email, profileImageUrl))
        .deliveryAddresses(
